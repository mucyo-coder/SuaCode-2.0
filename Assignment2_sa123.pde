...
int secondBallX = 427; //sets the x position of the second ball
int secondBallY = 240; //sets the y position of the second ball
...
void draw() //runs forever
{
  ...
  rect(width-17, height-95, paddleWidth, paddleHeight); //this is the 2nd paddle
...
//second ball
  ...
  ellipse(secondBallX, secondBallY, ballWidth, ballHeight);// this is the second ball
